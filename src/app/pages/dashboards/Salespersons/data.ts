import { ChartType } from "./salespersons.model";
...
var visitorsOptions: ChartType = {
    ...
    xaxis: {
        categories: ['Target Account 1', 'Target Account 2', 'Target Account 3', 'Target Account 4', 'Target Account 5', 'Target Account 6', 'Target Account 7', 'Target Account 8', 'Target Account 9', 'Target Account 10', 'Target Account 11', 'Target Account 12'],
    },
    markers: {
        size: 3,
        strokeWidth: 3,
